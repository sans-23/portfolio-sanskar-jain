    ...
    return(
        <section style={isActive===1 ? style1: style2} className="section sec3 portfolio">
            ...
            <div class="portfolios">
                ...
                <Link to="/sudoku"><PortfolioItem link="" img="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fdarksudoku.com%2Fassets%2Fimages%2Fgame-board.png&f=1&nofb=1"/></Link>
